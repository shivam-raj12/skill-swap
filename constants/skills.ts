// This file defines the hierarchical structure for skill selection.
// We will flatten the final selection into simple string arrays for the database.

interface SkillNode {
    id: string;
    name: string;
    subsections?: SkillNode[];
    subSubsections?: string[]; // Use array of strings for the final level
}
