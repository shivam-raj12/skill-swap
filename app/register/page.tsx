...
const RegisterPage: React.FC = () => {
    ...
    // Function that runs when the user clicks the "Create Account" button
    const handleRegister = async (e: React.FormEvent) => {
        e.preventDefault();
        // Basic validation check (You should add more!)
        ...
        try {
            ...
            // B. Create an active session for the new user immediately.
            await account.createEmailPasswordSession(email, password);

            // C. Send the verification link
            ...
            // The useAuth hook will eventually update the user state,
            // but we can manually trigger the redirect for a better experience.
            setTimeout(() => {
                router.push('/dashboard');
            }, 3000);

        } catch (err: any) {
            // Check for specific Appwrite error message and handle it simply
