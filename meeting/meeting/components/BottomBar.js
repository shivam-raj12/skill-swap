                ...
                renderRightComponent={() => {
                    return (
                        <>
                                    ...
                                    <>
                                        ...
                                        >
                                            <Popover.Panel className="absolute left-1/2 bottom-full z-10 mt-3 w-72 -translate-x-1/2 transform px-4 sm:px-0 pb-4">
                                                <div className="overflow-hidden rounded-lg shadow-2xl ring-1 ring-white ring-opacity-20">
                                                    <div className={" bg-gray-900 py-1"}>
                                                        <div>
                                                            <div className="flex items-center p-3 pb-0">
                                                                <p className="ml-3 text-sm text-gray-400 font-medium tracking-wider">
                                                                    {"MICROPHONE"}
                                                                </p>
                                                            </div>
                                                            <div className="flex flex-col">
                                                                {mics.map(({ deviceId, label }, index) => (
                                                                    <div
                                                                        className={`px-3 py-1 my-1 pl-6 text-white text-left cursor-pointer hover:bg-gray-700 transition duration-150 ease-in-out ${
                                                                            deviceId === selectedMic.id ? "bg-gray-700 font-semibold" : ""
                                                                        }`}
                                                                    >
                                                                        <button
                                                        ...
                                                        <hr className="border border-gray-700 mt-2 mb-1" />
                                                        <div>
                                                            <div className="flex p-3 pb-0">
                                                                <p className="ml-3 text-sm text-gray-400 font-medium tracking-wider text-center">
                                                                    {"SPEAKER"}
                                                                </p>
                                                            </div>
                                                            <div className="flex flex-col ">
                                                                {speakers.map(({ deviceId, label }, index) => (
                                                                    <div
                                                                        className={`px-3 py-1 my-1 pl-6 text-white cursor-pointer hover:bg-gray-700 transition duration-150 ease-in-out ${
                                                                            deviceId === selectedSpeaker.id ? "bg-gray-700 font-semibold" : ""
                                                                        }`}
                                                                    >
                                                                        <button
                                                                            className={`flex flex-1 w-full text-left`}
                            ...
                            {/* Removed: Explicit hover tooltip div */}
                        </>
                    );
                }}
            />
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="flex flex-col">
                                                                {webcams.map(({ deviceId, label }, index) => (
                                                                    <div
                                                                        className={`px-3 py-1 my-1 pl-6 text-white cursor-pointer hover:bg-gray-700 transition duration-150 ease-in-out ${
                                                                            deviceId === selectedWebcam.id ? "bg-gray-700 font-semibold" : ""
                                                                        }`}
                                                                    >
                                                                        <button
                                                                            className={`flex flex-1 w-full text-left`}
                    ...
                    >
                        <div className="fixed inset-0 overflow-y-hidden">
                            <div className="flex h-full items-end justify-end text-center">
                                <Dialog.Panel className="w-screen transform overflow-hidden bg-gray-800 shadow-xl ring-1 ring-white ring-opacity-20 transition-all">
                                    <div className="grid container bg-gray-800 py-6">
                                        <div className="grid grid-cols-12 gap-2">
                                            {otherFeatures.map(({ icon }) => {
                                                return (
                                                    <div
                                                        className={`grid items-center justify-center col-span-4 sm:col-span-3 md:col-span-2`}
                                                    >
                                                        {icon === BottomBarButtonTypes.RAISE_HAND ? (
