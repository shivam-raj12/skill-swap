...
const MobileMenu: React.FC<{ isOpen: boolean, closeMenu: () => void }> = ({ isOpen, closeMenu }) => {
    // Use a light background for the mobile menu, but still dark for contrast
    ...
    return (
        <div
            // Changed to a light background and dropped below the Navbar height (fixed top-20 to match nav height)
